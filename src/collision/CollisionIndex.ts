...
export class CollisionIndex {
	 ...
	 */
	constructor(transform: CollisionTransform, grid?: GridIndex) {
	 ...
	 */
	projectAndGetPerspectiveRatio(posMatrix: mat4, x: number, y: number): { point: Point; perspectiveRatio: number } {
