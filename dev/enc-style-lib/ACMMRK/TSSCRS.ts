...
const ACMMRK_TSSCRS_SYMBOL_0: SymbolLayerSpecification = {
	id: 'ACMMRK_TSSCRS_SYMBOL_0',
	type: 'symbol',
	...SOURCE_DESC,
	filter: ['==', ['get', 'OBJL'], 147],
	layout: {
...
const ACMMRK_TSSCRS_SYMBOL_1: SymbolLayerSpecification = {
	id: 'ACMMRK_TSSCRS_SYMBOL_1',
	type: 'symbol',
	...SOURCE_DESC,
	filter: [
		'all',
...
const symbols: SymbolLayerSpecification[] = [ACMMRK_TSSCRS_SYMBOL_0, ACMMRK_TSSCRS_SYMBOL_1]
