...
const ACMMRK_PRCARE_SYMBOL_0: SymbolLayerSpecification = {
	id: 'ACMMRK_PRCARE_SYMBOL_0',
	type: 'symbol',
	...SOURCE_DESC,
	filter: ['==', ['get', 'OBJL'], 96],
	layout: {
...
const ACMMRK_PRCARE_SYMBOL_1: SymbolLayerSpecification = {
	id: 'ACMMRK_PRCARE_SYMBOL_1',
	type: 'symbol',
	...SOURCE_DESC,
	filter: [
		'all',
...
const symbols: SymbolLayerSpecification[] = [ACMMRK_PRCARE_SYMBOL_0, ACMMRK_PRCARE_SYMBOL_1]
