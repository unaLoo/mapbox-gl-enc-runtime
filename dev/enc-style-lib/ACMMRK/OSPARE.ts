...
const ACMMRK_OSPARE_SYMBOL_0: SymbolLayerSpecification = {
	id: 'ACMMRK_OSPARE_SYMBOL_0',
	type: 'symbol',
	...SOURCE_DESC,
	filter: ['==', ['get', 'OBJL'], 88],
	layout: {
...
const ACMMRK_OSPARE_SYMBOL_1: SymbolLayerSpecification = {
	id: 'ACMMRK_OSPARE_SYMBOL_1',
	type: 'symbol',
	...SOURCE_DESC,
	filter: [
		'all',
...
const symbols: SymbolLayerSpecification[] = [ACMMRK_OSPARE_SYMBOL_0, ACMMRK_OSPARE_SYMBOL_1]
