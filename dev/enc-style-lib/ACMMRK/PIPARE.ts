...
const ACMMRK_PIPARE_SYMBOL_0: SymbolLayerSpecification = {
	id: 'ACMMRK_PIPARE_SYMBOL_0',
	type: 'symbol',
	...SOURCE_DESC,
	filter: ['==', ['get', 'OBJL'], 92],
	layout: {
...
const ACMMRK_PIPARE_SYMBOL_1: SymbolLayerSpecification = {
	id: 'ACMMRK_PIPARE_SYMBOL_1',
	type: 'symbol',
	...SOURCE_DESC,
	filter: [
		'all',
...
const symbols: SymbolLayerSpecification[] = [ACMMRK_PIPARE_SYMBOL_0, ACMMRK_PIPARE_SYMBOL_1]
