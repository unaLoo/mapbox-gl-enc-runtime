...
const ACMMRK_TSSRON_SYMBOL_0: SymbolLayerSpecification = {
	id: 'ACMMRK_TSSRON_SYMBOL_0',
	type: 'symbol',
	...SOURCE_DESC,
	filter: ['==', ['get', 'OBJL'], 149],
	layout: {
...
const ACMMRK_TSSRON_SYMBOL_1: SymbolLayerSpecification = {
	id: 'ACMMRK_TSSRON_SYMBOL_1',
	type: 'symbol',
	...SOURCE_DESC,
	filter: [
		'all',
...
const symbols: SymbolLayerSpecification[] = [ACMMRK_TSSRON_SYMBOL_0, ACMMRK_TSSRON_SYMBOL_1]
