...
const ACMMRK_SPLARE_SYMBOL_0: SymbolLayerSpecification = {
	id: 'ACMMRK_SPLARE_SYMBOL_0',
	type: 'symbol',
	...SOURCE_DESC,
	filter: ['==', ['get', 'OBJL'], 120],
	layout: {
...
const ACMMRK_SPLARE_SYMBOL_1: SymbolLayerSpecification = {
	id: 'ACMMRK_SPLARE_SYMBOL_1',
	type: 'symbol',
	...SOURCE_DESC,
	filter: [
		'all',
...
const symbols: SymbolLayerSpecification[] = [ACMMRK_SPLARE_SYMBOL_0, ACMMRK_SPLARE_SYMBOL_1]
