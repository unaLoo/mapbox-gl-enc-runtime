...
const ACMMRK_ISTZNE_SYMBOL_0: SymbolLayerSpecification = {
	id: 'ACMMRK_ISTZNE_SYMBOL_0',
	type: 'symbol',
	...SOURCE_DESC,
	filter: ['==', ['get', 'OBJL'], 68],
	layout: {
...
const ACMMRK_ISTZNE_SYMBOL_1: SymbolLayerSpecification = {
	id: 'ACMMRK_ISTZNE_SYMBOL_1',
	type: 'symbol',
	...SOURCE_DESC,
	filter: [
		'all',
...
const symbols: SymbolLayerSpecification[] = [ACMMRK_ISTZNE_SYMBOL_0, ACMMRK_ISTZNE_SYMBOL_1]
