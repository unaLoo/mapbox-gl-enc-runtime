...
const ACMMRK_SUBTLN_SYMBOL_0: SymbolLayerSpecification = {
	id: 'ACMMRK_SUBTLN_SYMBOL_0',
	type: 'symbol',
	...SOURCE_DESC,
	filter: ['==', ['get', 'OBJL'], 133],
	layout: {
...
const ACMMRK_SUBTLN_SYMBOL_1: SymbolLayerSpecification = {
	id: 'ACMMRK_SUBTLN_SYMBOL_1',
	type: 'symbol',
	...SOURCE_DESC,
	filter: [
		'all',
...
const symbols: SymbolLayerSpecification[] = [ACMMRK_SUBTLN_SYMBOL_0, ACMMRK_SUBTLN_SYMBOL_1]
